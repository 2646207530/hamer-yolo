...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/cyc/pycharm/vGesture/checkpoints/yolov7_best.pt', help='weights path')
    ...
    y = model(img)  # dry run
    print('pytorch框架进行检测输出结果:',y)

    # ONNX export
    try:
        import onnx
        print('\nStarting ONNX export with onnx %s...' % onnx.__version__)
        f = '/home/cyc/pycharm/vGesture/software/yolov7/yolotrtmodel/yolohand.onnx'  # 自定义路径
