...
class MANOTransformerDecoderHead(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # cfg.MANO.MEAN_PARAMS='/home/cyc/pycharm/vGesture/software/hamer/_DATA/data/mano_mean_params.npz'
        mean_params = np.load('/home/pt/fbs/model/hamer/_DATA/data/mano_mean_params.npz')
