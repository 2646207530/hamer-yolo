import numpy as np
import sys
from .KeypointFusion.manopth.manopth.manolayer import ManoLayer
...
class MANO(object):
    ...
    def get_layer(self):
        return ManoLayer(mano_root='/home/pt/fbs/model/hamer/_DATA/data/mano', flat_hand_mean=True, use_pca=False, side='right') # load right hand MANO model